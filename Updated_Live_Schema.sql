...
-- This file is intended for documentation, comparison, and source control.
-- It is non-destructive by design and does not include DROP statements.
-- If you want to rebuild a database from this file, run the CREATE statements
-- against an empty database or convert them into guarded CREATE/ALTER migrations.
